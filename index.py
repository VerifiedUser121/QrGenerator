...
class Qr_Generator:
    ...
    def generate(self):
        ...
        if (
        ...
        elif not re.match(name_pattern, self.var_name.get()):
            self.msg = "Enter a vaild name"
            self.lbl_msg.config(text=self.msg, fg="red")
        elif not re.match(name_pattern, self.var_department.get()):
            self.msg = "Enter a valid Dept. Name"
            self.lbl_msg.config(text=self.msg, fg="red")
        elif not re.match(name_pattern, self.var_designation.get()):
            self.msg = "Enter a valid Designation "
            self.lbl_msg.config(text=self.msg, fg="red")
            ...
            self.im = ImageTk.PhotoImage(
                file="employee/Emp_" + str(self.var_emp_code.get()) + ".png"
            )
